...
NAMING_CONVENTION = {
    ...
    "fk": "fk_%(table_name)s_%(column_0_name)s_%(referred_table_name)s", #외래키, fk_테이블명_컬럼명_부모테이블명
...
class AbstractBaseModel(DeclarativeBase):
    ...
    id: Mapped[int] = mapped_column(Identity(start = 1, increment = 1),primary_key = True) #기본키
